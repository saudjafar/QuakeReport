...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView locationOffsetView = (TextView) listItemView.findViewById(R.id.location_direction);
        ...
        // Format the date string (i.e. "Mar, 1984")
        SimpleDateFormat simpleDateFormatter = new SimpleDateFormat("MMM, yyyy");
